...
export const RebrandNotice = () => {
  return (
    <section className="py-8 bg-gradient-to-r from-yellow-900/20 to-green-900/20 border-y border-yellow-500/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/10 via-green-900/10 to-yellow-900/10 animate-pulse"></div>
      
      <div className="container mx-auto px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center mb-2 group">
            <Zap className="w-6 h-6 text-yellow-400 mr-2 animate-pulse transition-all duration-300 group-hover:scale-125 group-hover:rotate-12" />
            ...
            <Zap className="w-6 h-6 text-yellow-400 ml-2 animate-pulse transition-all duration-300 group-hover:scale-125 group-hover:-rotate-12" />
          </div>
